...
function normalizeTransactionRow(row, accountId, userId, financialYear) {
    ...
    const rawDate = row[lowerMap['date']] || row[lowerMap['txn date']] || row[lowerMap['post date']] || row[lowerMap['value date']] || row[lowerMap['transaction']] || row[lowerMap['value']] || row[lowerMap['trans date and']] || row[lowerMap['tran date']] || row[lowerMap['tran']] || row[lowerMap['tran. date']] || row[lowerMap['date(value']] || row[lowerMap['date (value date)']] || '';
